...
| 5 | open-feature-pr preconditions/Verification assume the feature lane         | Rule missing                       | Add a chore-lane variant: preconditions = all gates pasted green (or delta-justified) + tracker flipped; Verification = the gates table. |
